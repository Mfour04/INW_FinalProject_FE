...
export const Toast = ({ message, onClose } : ToastProps) => {
    ...
    return (
        <div className="h-14 bg-white text-left flex items-center content-center text-black rounded-md px-4 py-2 w-72 shadow-lg relative animate-slideIn">
            <p>{message}</p>
            <button
                className=" absolute top-0 cursor-pointer text-xl right-2 text-[#ff6740] hover:text-orange-400 transition"
                onClick={onClose}
            >
                &times;
            </button>
