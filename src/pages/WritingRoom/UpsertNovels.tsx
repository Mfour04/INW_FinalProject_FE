...
import { CreateNovels, GetNovelById, UpdateNovels } from '../../api/Novels/novel.api'
...
export const UpsertNovels = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1e1e21] text-white px-6 py-8 rounded-[10px] mx-[50px]">
        ...
        <Button isLoading={createNovelMutation.isPending || updateNovelMutation.isPending} onClick={handleUpsertNovelClick} className="bg-[#ff6740] hover:bg-[#e14b2e] text-white px-5 py-2 rounded-md text-sm font-semibold">
