    ...
    <section className="p-2 py-2 px-3 mb-4">
      ...
      <div className="grid grid-cols-1 gap-5">
          ...
          {publishOption === "scheduled" && (
            <div className="flex items-center gap-5 flex-wrap mt-4">
              ...
              <div className="relative">
                <input
                  type="date"
                  className="h-9 w-[160px] md:w-[200px] rounded-xl bg-white ring-1 ring-zinc-200 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-300 text-zinc-900 placeholder:text-zinc-400 dark:bg-white/[0.06] dark:ring-white/10 dark:focus:ring-white/25 dark:text-white"
                  min={minDate}
                  value={dateStr}
                  onChange={(e) => setDateStr(e.target.value)}
                />
                <CalendarDays className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-zinc-500 dark:text-white/60 pointer-events-none" />
              </div>
            </div>
          )}
        </div>
        ...
        <div className="rounded-2xl ring-1 p-3 md:p-4 bg-white ring-zinc-200 dark:bg-white/[0.02] dark:ring-white/10">
          ...
          <div className="mt-3 flex items-center gap-2 text-[12.5px] text-zinc-600 dark:text-white/75">
            {isPaid ? (
              <>
        ...
        return (
          <button
            ...
            className={[
              ...
              active
                ? "bg-zinc-100 ring-zinc-200 text-zinc-900 dark:bg-white/[0.1] dark:ring-white/20 dark:text-white"
                : "bg-white ring-zinc-200 hover:bg-zinc-100 text-zinc-800 dark:bg-white/[0.04] dark:ring-white/10 dark:hover:bg-white/[0.06] dark:text-white/90",
            ].join(" ")}
          >
            <div className="flex items-center gap-2">
              <span
                className={[
                  ...
                  active
                    ? "bg-zinc-200 ring-zinc-300 text-zinc-800 dark:bg-white/[0.18] dark:ring-white/20 dark:text-white/90"
                    : "bg-zinc-100 ring-zinc-200 text-zinc-700 dark:bg-white/[0.08] dark:ring-white/10 dark:text-white/80",
                ].join(" ")}
              >
  ...
  return (
    <button
      ...
      className={[
        ...
        active
          ? "text-white ring-white/20 shadow-[0_6px_20px_-8px_rgba(255,99,64,0.4)] bg-[linear-gradient(90deg,#ff512f,#ff9966)]"
          : "bg-zinc-100 text-zinc-800 ring-zinc-200 hover:bg-zinc-200/70 dark:bg-white/[0.06] dark:text-white/90 dark:ring-white/12 dark:hover:bg-white/[0.1]",
      ].join(" ")}
      title={`${value} coin`}
