...
const makeMatch = (sim: number): MatchItem => ({
  novelSlug: `tieu-thuyet-${Math.random().toString(36).slice(2, 6)}`,
  novelTitle: `Tiểu thuyết ${Math.random().toString(36).slice(2, 4).toUpperCase()}`,
...
export const generateMockMatches = (n = 10): MatchItem[] =>
