...
type WithdrawConfirmModalProps = {
  isOpen: boolean;
  coinAmount: number;    // Xu
  vndAmount: number;     // VND
  onCancel: () => void;
  onConfirm: () => void;
  loading?: boolean;
};
...
export const WithdrawConfirmModal: React.FC<WithdrawConfirmModalProps> = ({
  ...
  const content = (
    ...
    >
      ...
      >
        {/* Header với dải gradient */}
        <div className="relative px-5 pt-5">
          <div className="absolute inset-x-0 -top-20 h-32 pointer-events-none select-none opacity-70 blur-2xl
  ...
  // Render qua portal để tách khỏi stack layout hiện tại
